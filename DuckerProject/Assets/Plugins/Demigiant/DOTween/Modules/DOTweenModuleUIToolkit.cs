...
namespace DG.Tweening
{
	public static class DOTweenModuleUIToolkit
    {
        ...
        /// <param name="endValue">The end value to reach</param><param name="duration">The duration of the tween</param>
        /// <param name="snapping">If TRUE the tween will smoothly snap all values to integers</param>
        //blic static TweenerCore<Vector2, Vector2, VectorOptions> DOMove(this VisualElement target, Vector2 endValue, float duration, bool snapping = false)
       //
            //eenerCore<Vector2, Vector2, VectorOptions> t
                // = DOTween.To(() => (Vector2)target.resolvedStyle.translate, x => target.style.translate = x, endValue, duration);
            // etOptions(snapping).SetTarget(target);
           //eturn t;
       //
